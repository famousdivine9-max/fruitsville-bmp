  ...
  return (
    <>
      ...
      <form onSubmit={onSubmit} className="card mb-8 grid gap-4 p-5 sm:grid-cols-2 lg:grid-cols-6">
        ...
        {product && unitPrice && (
          <p className="text-sm text-gray-600 sm:col-span-2 lg:col-span-6">
            Total: <strong className="text-ink">{formatMoney(Number(quantity) * Number(unitPrice), currency)}</strong>
          </p>
        )}
      </form>
      ...
      <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <p className="ml-auto text-sm">Day total: <strong className="text-ink">{formatMoney(total, currency)}</strong></p>
      </div>
